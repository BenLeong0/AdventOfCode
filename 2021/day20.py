...
test_algorithm, test_image = get_input("inputs/day20_test.in")
full_algorithm, full_image = get_input("inputs/day20.in")
...
def find_number_of_lit_pixels(
    ...
    for i in range(iterations):
        ...
        new_image = [get_empty_row(width) for _ in range(height)]
